			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" style="cursor: pointer"></a><a href="//ReportMember">신고회원내역</a></li>
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									<c:forEach items="${I_LIST2}" var="vo">			
									<tr class="odd gradeX">
										<td>${vo.reportMemSeq} 
										<button class="btn pull-right" onclick="location='/ReportDetailMemberList?mseq=${vo.mseq}'">
										<i class="fa fa-edit "></i>신고회원상세보기 </button></td>
										<td>${vo.mseq}</td>
