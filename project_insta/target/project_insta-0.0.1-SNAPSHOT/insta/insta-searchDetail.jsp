                     ...
                     <div class="row">
                        <article id="01" class="post-block col-md-12 post hentry">
                           <div class="post-detail">
                              <div class="metas">
                                 Posted on: <a href="#!" class="meta-date">${vo.regdate }</a>/&nbsp;
                                 Posted by: <a href="#!" class="meta-author">${vo.mseq }</a>/&nbsp;
                                 ...
                                 <div class="meta-cat">
                              <input type="hidden" id="aHashtag"  name="aHashtag" value="${hashtag }">
                                 <a rel="category tag"  id="hashtagOne">${hashtag }&nbsp;</a>
                              </div>
                              </c:forEach>
                              </form>
                           ...
                           <div class="img-wrap">
                              <a href="">
                                 <img class="img-responsive" src="/insta/instaImage/${vo.fileName }" alt="">
                              </a>
                           </div>
                          ...
                          <c:forEach items="${replyList }" var="rList">
                           ...
                           <button type="submit" value="등록" title="댓글 등록"></button>
                           </form>
                           </div>
                        </article>
                     </div>
...
<script >
$('#hashtagOne').click(function() { $('#hashtagForm').submit(); });
</script>
