...
<title>Make America Greatest Again</title>
</head>
<body>
<br>
<h2>'혼자왔니?' 서비스 이용약관</h2>
...
<h3>제 1 장 총 칙</h3><br>
<h4>제1조 목적</h4><hr>
이 약관은 '혼자왔니?' 서비스(이하 "서비스")의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.<br>
<br>
<h4>제2조 용어의 정의</h4><hr>
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br>
 - '서비스'란 '회원'이 이용할 수 있는 '혼자왔니' 및 관련 제반 서비스를 의미합니다.<br>
 ...
 - '게시물'이라 함은 '회원'이 '서비스'를 이용함에 있어 게시한 부호,문자,화상 등의 정보형태의 글,사진,동영상 및 각종 파일과 링크 등을 말합니다.<br>
<br>
<h4>제3조 약관의 효력 및 변경</h4><hr>
(1) '서비스제공자'는 이 약관의 내용을 '회원'이 쉽게 알 수 있도록 '이용약관'화면 및 회원가입 절차시 게시합니다.<br>
(2) 이 약관은 '서비스제공자'가 '혼자왔니?'를 통해 공시함으로서 효력을 발생합니다. <br>
...
<br>
<br>
<h3> 제 3 장 계약 당사자의 의무</h3><br>
<h4>제7조 '서비스제공자'의 의무</h4><hr>
...
<br>
<br>
<h3>제 4 장 서비스 이용</h3><br>
<h4>제9조 서비스의 제공</h4><hr>
...
<br>
<h4>제13조 재화 등의 광고서비스 및 예약시스템 제공 </h4><hr>
...
다만 '서비스 제공자'는 '판매사업자'의 동의아래 '판매사업자'에게  제공된 예약시스템 상에서 '회원'이 예약할때 해당 예약정보가  (혼자왔니?)'서비스'에 제공됨을 명시해야합니다.<br>
<br>
<h4>제15조 회원의 게시물</h4><hr>
...
단, 이 경우 '회원'은 언제든지 문의 게시판 또는 문의메일(yuinye@gmail.com)을 통해 해당 '게시물'대해 삭제, 비공개 등의 요청을 할 수 있습니다.<br>
...
<br>
<h4>제17조 연결“회사”와 피연결“회사” 간의 관계</h4><hr>
