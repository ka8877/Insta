...
<body>
	...
	<div class="gap gap-small"></div>
		<div class="row">
				<div class="col-md-10">
				<!--  리스트 뿌리기 -->
				<form action="/boardsUpdate.do" method="post" id="frm">
					<div class="col-md-9">
						<div class="form-group">
							...
							<div class="gap gap-small"></div>
							<div><strong>타이틀</strong>&nbsp;&nbsp;<input type="email" placeholder=" 제목을 입력하세요." name="boaTitle" size="64" maxlength="62" value="${bVO.boaTitle }"/></div>
						</div>
					</div>
					<div class="gap gap-small"></div>
					<textarea name="smarteditor" id="smarteditor" rows="1" cols="1"
						style="width: 100%; height: 550px; display: none;">${bVO.boaCon }</textarea>
					저작권 등 다른 사람의 권리를 침해하거나 명예를 훼손하는 게시글은 이용약관 및 관련법률에 의해 제재를 받으실 수
					있습니다.
					<div class="gap gap-small"></div>
					<div class="col-md-12" align="center">
						<input class="btn btn-ghost btn-primary" type="button"
							id="savebutton" value="글수정" style="text-align: right;" />
					</div>
					<input type="hidden" value="${bVO.catePk }" name="catePk">
					<input type="hidden" value="${bVO.boaPk }" name="boaPk">
				</form>
				<!-- 리스트뿌리기 끝 -->
