                ...
                <!-- 카테고리 -->
                 <aside class="booking-filters booking-filters-white">
                        ...
                        <ul class="list booking-filters-list">
                            <li>
                           <div id="bold"><a class="booking-filters-title" id="leftCate" style="font-weight: bold; cursor:pointer;" href="/cateBoardsAllList.do?catePk=${catePk }">전체 : 게시글 모아보기</a></div>
                            </li>
                            <li>
                ...
                <div class="col-md-9">
                    ...
                    <div class="nav-drop booking-sort">
                        ...
                        <ul class="nav-drop-menu">
                            <li onclick="location.href='/cateBoardsAllList.do?catePk=${catePk }'"><a href="/cateBoardsAllList.do?catePk=${catePk }">최신순</a>
                            </li>
                            <li onclick="location.href='/boardsAllscrap.do?catePk=${catePk }'"><a href="/cateBoardsAllList.do?catePk=${catePk }">스크랩순</a>
                            </li>
                           <li onclick="location.href='/boardsAllreply.do?catePk=${catePk }'"><a href="/cateBoardsAllList.do?catePk=${catePk }">댓글순</a>
                        </ul>
                    </div>
                    	<!--  정렬하기 끝 -->
                    <!--  리스트 뿌리기 -->
                    ...
                    <ul class="booking-list">
                        <li>
                            <a class="booking-item" href="/boardsDetail.do?catePk=${catePk}&boaPk=${b.boaPk }&boaGubun=1">
                                <div class="row">
                                    <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <form action="/boardsSearch.do" id="searchForm">
                        ...
                        <input type="hidden" value="1" name="boaGubun">
